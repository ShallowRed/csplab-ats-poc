...
onMounted(() => {
  const title = typeof route.meta.title === 'string' ? route.meta.title : 'Intervieweurs'
  pageHeader.setTitle(title)
  pageHeader.setBreadcrumb([{ label: 'Entretiens' }, { label: title, to: '/intervieweurs' }])
    ...
    <Card>
      ...
      <CardContent>
        <p class="csplab-page__muted">
          La gestion des intervieweurs sera livrée en phase 2.
        </p>
      </CardContent>
    </Card>
  </div>
